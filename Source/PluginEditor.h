...
class InjuryEditor  : public juce::AudioProcessorEditor,
                       private juce::Button::Listener,
                       private InjuryProcessor::Listener
{
public:
    explicit InjuryEditor (InjuryProcessor&);
    ~InjuryEditor() override;
...
private:
    ...
    struct OscPanel
    {
        ...
        explicit OscPanel (InjuryProcessor& p, int idx)
            : waveform (p, idx),
              oscOnBtn    ("ON"),
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (InjuryEditor)
};
