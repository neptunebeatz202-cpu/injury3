...
const juce::Colour InjuryLAF::kBg      { 0xff050505 };
const juce::Colour InjuryLAF::kPanel   { 0xff0b0b0b };
const juce::Colour InjuryLAF::kBorder  { 0xff1f1f1f };
const juce::Colour InjuryLAF::kAccent  { 0xff8b0000 };   // dark blood red
const juce::Colour InjuryLAF::kAccent2 { 0xff5a1a1a };   // dim rust
const juce::Colour InjuryLAF::kDim     { 0xff4a4a4a };
const juce::Colour InjuryLAF::kTrack   { 0xff141414 };
...
//==============================================================================
void InjuryLAF::drawRotarySlider (juce::Graphics& g,
...
//==============================================================================
void InjuryLAF::drawLinearSlider (juce::Graphics& g,
                                    int x, int y, int width, int height,
...
//==============================================================================
void InjuryLAF::drawButtonBackground (juce::Graphics& g, juce::Button& button,
                                       const juce::Colour&,
...
//==============================================================================
void InjuryLAF::drawToggleButton (juce::Graphics& g, juce::ToggleButton& button,
                                   bool highlighted, bool /*down*/)
{
    auto b   = button.getLocalBounds().toFloat().reduced (0.5f);
...
//==============================================================================
juce::Label* InjuryLAF::createSliderTextBox (juce::Slider& slider)
{
...
juce::Font InjuryLAF::getLabelFont (juce::Label&)
{
    return juce::Font (10.0f, juce::Font::bold);
}

//==============================================================================
void InjuryLAF::paintGrungePanelBg (juce::Graphics& g, juce::Rectangle<int> bounds,
...
//==============================================================================
void InjuryLAF::paintInjuryTitle (juce::Graphics& g, juce::Rectangle<int> bounds)
{
    auto bf = bounds.toFloat();
    ...
    g.drawText ("INJURY", bf.translated (2.0f, 2.0f).toNearestInt(),
                juce::Justification::centredLeft);

    // Main text — dim white
    g.setColour (juce::Colours::white.withAlpha (0.85f));
    g.drawText ("INJURY", bf.toNearestInt(), juce::Justification::centredLeft);
